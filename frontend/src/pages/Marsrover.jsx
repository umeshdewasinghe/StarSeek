...
<main className="min-h-screen flex flex-col items-center justify-center bg-gray-900">
  <section className="bg-white rounded-lg shadow-lg p-8 w-full md:max-w-md">
    <div className="text-center mb-6">
      <p className="text-3xl font-bold text-gray-900">Rover Photos</p>
    </div>
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        <label className="block mb-1 text-gray-700">Search By:</label>
        <div>
      ...
      {searchBy === 'sol' ? (
        <div className="mb-4">
          <label htmlFor="sol" className="block mb-1 text-gray-700">Martian Sol:</label>
          <input type="number" id="sol" value={sol} onChange={(e) => setSol(e.target.value)} className="border border-gray-400 rounded px-2 py-1" />
        </div>
      ) : (
        <div className="mb-4">
          <label htmlFor="earthDate" className="block mb-1 text-gray-700">Earth Date:</label>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 transition-opacity duration-500 ${showTransition ? 'opacity-100' : 'opacity-0'}'">
    {photos.map(photo => (
